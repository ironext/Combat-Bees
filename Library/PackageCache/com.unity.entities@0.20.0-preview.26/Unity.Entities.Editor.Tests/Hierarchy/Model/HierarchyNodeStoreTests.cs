...
namespace Unity.Entities.Editor.Tests
{
    ...
    sealed class HierarchyNodeStoreTests
    {
        ...
        public void SchedulePacking_WithNoNodes_DoesNotThrow()
        {
            ...
            {
                m_HierarchyNodeStore.ExportImmutable(m_World.EntityManager, packed);
        ...
        public void SchedulePacking_UpdatesDepth_WhenReusingNodesFromPreviousBuffer()
        {
            ...
            m_HierarchyNodeStore.ExportImmutable(m_World.EntityManager, buffer1, buffer2);
            ...
            m_HierarchyNodeStore.ExportImmutable(m_World.EntityManager, buffer2, buffer1);
        ...
        public void Parenting_WhenNewNodesCreated_ChangeVersionIsPropagated()
        {
            ...
            m_HierarchyNodeStore.ExportImmutable(m_World.EntityManager, nodes);
