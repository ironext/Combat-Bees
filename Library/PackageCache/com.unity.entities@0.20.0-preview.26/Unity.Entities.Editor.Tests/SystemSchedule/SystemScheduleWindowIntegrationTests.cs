...
namespace Unity.Entities.Editor.Tests
{
    partial class SystemScheduleWindowIntegrationTests
    {
        ...
        public IEnumerator SystemScheduleWindow_HashCodeForTwoSystemsWithSameType()
        {
            ...
            var testSystemHashDefaultWorld = testSystemItemDefaultWorld.Node.Hash;
            ...
            var testSystemHashTestWorld = testSystemItemTestWorld.Node.Hash;

            Assert.That(testSystemHashDefaultWorld, Is.Not.EqualTo(testSystemHashTestWorld));
