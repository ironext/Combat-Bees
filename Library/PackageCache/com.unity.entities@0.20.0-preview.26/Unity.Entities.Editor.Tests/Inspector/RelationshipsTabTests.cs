...
namespace Unity.Entities.Editor.Tests
{
    partial class RelationshipsTabTests
    {
        ...
        public unsafe void RelationshipsTab_MatchQuery()
        {
            ...
            var matchingQueries = new List<QueryViewData>();
            RelationshipsTab.GatherMatchingQueries(w.EntityManager.GetCheckedEntityDataAccess()->EntityComponentStore, entities[0], ref queryList, matchingQueries, w, "systemA");
            Assert.That(matchingQueries, Is.Not.Empty);

            matchingQueries.Clear();
            RelationshipsTab.GatherMatchingQueries(w.EntityManager.GetCheckedEntityDataAccess()->EntityComponentStore, entities[1], ref queryList, matchingQueries, w, "systemB");
