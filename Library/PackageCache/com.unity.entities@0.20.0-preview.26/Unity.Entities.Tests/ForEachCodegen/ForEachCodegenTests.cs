...
namespace Unity.Entities.Tests.ForEachCodegen
{
    ...
    public partial class ForEachCodegenTests : ECSTestsFixture
    {
        ...
        private MyImplicitProfilingDoesntClearStackSystem ImplicitProfilingDoesntClearStackSystem;
...
// OrderBy isn't supported in DOTS-Runtime
        ...
        [Test]
        public void UseOfConstantFloatValueInLambda()
        {
            TestSystem.UseOfConstantFloatValueInLambda();
        }
