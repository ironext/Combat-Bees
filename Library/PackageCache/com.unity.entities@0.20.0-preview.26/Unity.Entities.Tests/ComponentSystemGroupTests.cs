...
// https://unity3d.atlassian.net/browse/DOTSR-1432
        ...
        struct UnmanagedSystemWithSyncPointAfterSchedule : ISystem
        {
...
*/
        [BurstCompile]
        struct BurstCompiledUnmanagedSystem : ISystem
        {
            [BurstCompile]
            struct MyJob : IJobChunk
            {
        ...
        unsafe struct UnmanagedSystemWithRefA : ISystem
        {
        ...
        unsafe struct UnmanagedSystemWithRefB : ISystem
        {
