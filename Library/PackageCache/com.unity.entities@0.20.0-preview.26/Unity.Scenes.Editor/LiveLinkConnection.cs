...
namespace Unity.Scenes.Editor
{
    ...
    class LiveLinkConnection
    {
        ...
        {
            return GetLiveLink(AssetDatabaseCompatibility.PathToGUID(scene.path));
        }
        ...
        public void Update(List<LiveLinkChangeSet> changeSets, NativeList<Hash128> loadScenes, NativeList<Hash128> unloadScenes, LiveConversionMode mode)
        {
        ...
        void AddLiveLinkChangeSet(ref LiveLinkDiffGenerator liveLink, Hash128 sceneGUID, List<LiveLinkChangeSet> changeSets, LiveConversionMode mode)
        {
            ...
            try
            {
                ...
                changeSets.Add(LiveLinkDiffGenerator.UpdateLiveLink(editScene, sceneGUID, ref liveLink, mode, _BuildConfigurationGUID, _BuildConfiguration));
            }
            finally
            {
                if (liveLink != null)
