...
namespace Unity.Scenes.Editor
{
    ...
    class LiveLinkDiffGenerator : IDisposable
    {
        ...
        GameObjectConversionSettings PrepareConversion(World dstWorld, GameObjectConversionUtility.ConversionFlags flags, GUID buildConfigurationGUID, BuildConfiguration buildConfig)
        {
            ...
            // don't run dots runtime conversion systems for livelink in the editor
        ...
        public static LiveLinkChangeSet UpdateLiveLink(Scene scene, Hash128 sceneGUID, ref LiveLinkDiffGenerator liveLinkData, LiveConversionMode mode, GUID configGUID, BuildConfiguration config)
        {
            ...
            var liveLinkEnabled = mode != LiveConversionMode.Disabled;
            ...
            {
                EntityManager targetEntityManager = liveLinkData._IncrementalConversionDebug.World.EntityManager;
