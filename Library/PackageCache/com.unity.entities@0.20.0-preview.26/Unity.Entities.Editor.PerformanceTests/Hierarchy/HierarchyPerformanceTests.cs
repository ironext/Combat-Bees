...
namespace Unity.Entities.Editor.PerformanceTests
{
    ...
    class HierarchyPerformanceTests
    {
		    ...
		    ScenarioId scenarioId)
	    {
		    ...
		    Measure.Method(() =>
		    {
			    hierarchy.IntegrateEntityChanges(world.EntityManager, changes);
		    }).WarmupCount(1)
			    .SetUp(() =>
			    {
				    hierarchy.Clear();
		    ...
		    ScenarioId scenarioId)
	    {
		    ...
		    Measure.Method(() =>
			    {
				    hierarchy.ExportImmutable(world.EntityManager, immutable);
			    }).WarmupCount(1)
			    .IterationsPerMeasurement(10)
			    .Run();
		    ...
		    ScenarioId scenarioId)
	    {
		    ...
		    {
			    hierarchy.IntegrateEntityChanges(world.EntityManager, changes);
			    hierarchy.ExportImmutable(world.EntityManager, immutable0);
		    }
			    
		    Measure.Method(() =>
			    {
				    hierarchy.ExportImmutable(world.EntityManager, immutable1, immutable0);
			    }).WarmupCount(1)
			    .IterationsPerMeasurement(10)
			    .Run();
