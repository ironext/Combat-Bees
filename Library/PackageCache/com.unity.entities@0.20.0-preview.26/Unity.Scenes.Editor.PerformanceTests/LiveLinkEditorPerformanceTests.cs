...
namespace Unity.Scenes.Editor.Tests
{
    [Serializable]
    [TestFixture]
    class LiveLinkEditorPerformanceTests
    {
        [SerializeField] TestWithEditorLiveLink m_Test;
        ...
        struct MeasureLiveConversionTime
        {
            ...
            private readonly EditorSubSceneLiveLinkSystem m_System;
            private readonly SampleGroup m_SampleGroup;
            public MeasureLiveConversionTime(World w)
            {
                m_System = w.GetExistingSystem<EditorSubSceneLiveLinkSystem>();
                m_System.MillisecondsTakenByUpdate = 0;
                m_SampleGroup = new SampleGroup(nameof(EditorSubSceneLiveLinkSystem));
            }
        ...
        public IEnumerator LiveConversion_Performance_MoveHierarchyRoot([Values(1, 5, 10)]int depth, [Values] ObjectKind kind)
        {
            ...
            var w = m_Test.GetLiveLinkWorld(TestWithEditorLiveLink.Mode.Edit);
