...
namespace Unity.Entities.CodeGen.SourceGenerators.Tests
{
    ...
    public class ForEachISystemErrorTests : SourceGenTests
    {
        ...
        [Test]
        public void DC0019_ISystem_EFE_WithSharedComponentParam()
        {
            const string source = @"
            ...
            AssertProducesError(source, "DC0019");
        }

#if !UNITY_DISABLE_MANAGED_COMPONENTS
        [Test]
        public void DC0023_ISystem_EFE_WithManagedComponentParam()
        {
            const string source = @"
            ...
            AssertProducesError(source, "DC0023");
        }
#endif
