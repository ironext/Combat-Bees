...
namespace Unity.Entities.Tests
{
    ...
    class CompanionComponentsEditorTests
    {
        ...
        {
            TestWithEditorLiveLink.OneTimeTearDown();
        }
        
        [SetUp]
        public void SetUp()
        {
            TestWithEditorLiveLink.SetUp();
        }
        ...
        IEditModeTestYieldInstruction GetEnterPlayMode(bool editMode) => TestWithEditorLiveLink.GetEnterPlayMode(editMode ? TestWithEditorLiveLink.Mode.Edit : TestWithEditorLiveLink.Mode.Play);
        ...
        public IEnumerator CompanionComponent_SceneCulling([Values]bool editMode, [Values]bool sceneViewShowRuntime)
        {
            ...
            var subScene = TestWithEditorLiveLink.CreateSubSceneFromObjects("TestSubScene", true, () =>
            {
