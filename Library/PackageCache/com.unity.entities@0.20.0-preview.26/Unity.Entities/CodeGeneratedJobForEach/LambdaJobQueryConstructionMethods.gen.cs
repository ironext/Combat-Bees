...
namespace Unity.Entities
{
    public static class LambdaJobQueryConstructionMethods
    {
        ...
        public static ForEachLambdaJobDescriptionJCS WithSharedComponentFilter<T1, T2>(this ForEachLambdaJobDescriptionJCS description, [AllowDynamicValue] T1 sharedComponent1, [AllowDynamicValue] T2 sharedComponent2) where T1 : struct, ISharedComponentData where T2 : struct, ISharedComponentData => description;
        public static ForEachLambdaJobDescriptionJCS WithFilter(this ForEachLambdaJobDescriptionJCS description, [AllowDynamicValue] NativeArray<Entity> entities) => description;
