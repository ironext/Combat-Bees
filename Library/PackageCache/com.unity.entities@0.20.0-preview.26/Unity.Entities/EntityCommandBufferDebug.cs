...
namespace Unity.Entities
{
    ...
    public unsafe partial struct EntityCommandBuffer
    {
        ...
        internal class MultipleEntitiesCommandView : BasicCommandView
        {
            ...
            public MultipleEntitiesCommandView(ECBCommand commandType, int sortKey, int totalSize, EntityNode entities, int entitiesCount, Allocator allocator)
            {
                CommandType = commandType;
                SortKey = sortKey;
                TotalSizeInBytes = totalSize;
        ...
        internal class MultipleEntitiesComponentCommandView : MultipleEntitiesCommandView
        {
            ...
            public MultipleEntitiesComponentCommandView(ECBCommand commandType, int sortKey, int totalSize,
                EntityNode entities, int entitiesCount, Allocator allocator, int componentTypeIndex, int componentSize,
                byte* componentValue)
            {
                CommandType = commandType;
                SortKey = sortKey;
        ...
        internal class MultipleEntitiesComponentCommandWithObjectView : MultipleEntitiesCommandView
        {
            ...
            public MultipleEntitiesComponentCommandWithObjectView(ECBCommand commandType, int sortKey, int totalSize, EntityNode entities, int entitiesCount, Allocator allocator, int componentTypeIndex, int hashCode, EntityComponentGCNode gcNode)
            {
                CommandType = commandType;
                SortKey = sortKey;
                TotalSizeInBytes = totalSize;
        ...
        internal class MultipleEntitiesAndComponentsCommandView : MultipleEntitiesCommandView
        {
            ...
            public MultipleEntitiesAndComponentsCommandView(ECBCommand commandType, int sortKey, int totalSize, EntityNode entities, int entitiesCount, Allocator allocator, ComponentTypes types)
            {
                CommandType = commandType;
                SortKey = sortKey;
                TotalSizeInBytes = totalSize;
