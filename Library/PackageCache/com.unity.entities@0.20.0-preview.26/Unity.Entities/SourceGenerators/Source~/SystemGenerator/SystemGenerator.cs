                ...
                foreach (var syntaxTree in syntaxTreesWithCandidate)
                {
                    ...
                    foreach (var systemTypeSyntax in systemTypesInTree)
                    {
                        ...
                        if (!(systemType.InheritsFromType("Unity.Entities.SystemBase") ||
                              ...
                              systemType.InheritsFromType("Unity.Entities.JobComponentSystem")))
                            continue;
                        ...
                        // Otherwise we may catch JobComponentSystems that have no changes made to them, and use no generated code.
                        ...
                        additionalUsings.UnionWith(systemTypeGeneratorContext.GetAdditionalUsings());
                    }
