            ...
            int id)
        {
            try
            {
                ...
                if (SystemTypeSymbol is INamedTypeSymbol namedSystemTypeSymbol)
                {
                    ...
                    else if (namedSystemTypeSymbol.Is("Unity.Entities.JobComponentSystem"))
                        SystemType = SystemType.JobComponentSystem;
                    else
                ...
                EntityQueryOptions GetEntityQueryOptions()
                {
                    ...
                    foreach (var invocation in invocations)
                    {
                        ...
                        else
                        {
                            ...
                            LambdaJobsErrors.DC0064(SystemGeneratorContext, invocation.GetLocation());
                        }
                    }
                    return options;
                }
