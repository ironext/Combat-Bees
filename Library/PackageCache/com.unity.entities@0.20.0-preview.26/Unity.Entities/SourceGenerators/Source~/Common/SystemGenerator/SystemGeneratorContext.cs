...
{
    public readonly struct SystemGeneratorContext
    {
        ...
        readonly List<MemberDeclarationSyntax> _newMembers;
        readonly HashSet<string> _additionalUsings;
        readonly List<string> _onCreateForCompilerAdditionalSyntax;
            ...
            IEnumerable<string> preprocessorSymbolNames)
        {
            ...
            _newMembers = new List<MemberDeclarationSyntax>();
            _additionalUsings = new HashSet<string>();
            _onCreateForCompilerAdditionalSyntax = new List<string>();
        }
        ...
        public void AddNewMember(MemberDeclarationSyntax newMember) => _newMembers.Add(newMember);
        public void AddNewUsing(string usingString) => _additionalUsings.Add(usingString);
        ...
        public IEnumerable<string> GetAdditionalUsings() => _additionalUsings;
        ...
        public TypeDeclarationSyntax GeneratePartialType()
        {
            ...
            foreach (var kvp in _originalMethodToReplacements)
            {
                ...
                var stableHashCode =
                    SourceGenHelpers.GetStableHashCode($"{originalMethodSymbol.ContainingType.Name}_{targetMethodNameAndSignature}") & 0x7fffffff;
            ...
            generatedClassDeclaration = generatedClassDeclaration.AddMembers(_newMembers.ToArray());
