...
namespace Unity.Entities.SourceGen.Common
{
    public static class SyntaxExtensions
    {
        ...
        public static string GetGeneratedSourceFileName(this SyntaxTree syntaxTree, string generatorName)
        {
            ...
            if (isSuccess)
                fileName = $"{fileName}{postfix}.g.cs";
            else
        ...
        public static (bool Success, ForEachType Type) CheckIsForEach(this InvocationExpressionSyntax syntax, SemanticModel model)
        {
            ...
            {
                return (true, ForEachType.LambdaJobs);
            }

            if (methodSymbol.ContainingType.Is("Unity.Entities.JobEntitiesForEachExecutionMethods"))
            {
                return (true, ForEachType.JobEntitiesForEach);
            }
            return (false, default);
        }
    }
