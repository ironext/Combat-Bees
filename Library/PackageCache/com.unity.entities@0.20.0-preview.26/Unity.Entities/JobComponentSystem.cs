...
namespace Unity.Entities
{
    ...
    public unsafe abstract class JobComponentSystem : ComponentSystemBase
    {
        ...
        unsafe JobHandle BeforeOnUpdate()
        {
            ...
            state->m_PreviousSystemID = SystemState.SetCurrentSystemIdForJobDebugger(state->m_SystemID);
            #endif
...
#pragma warning restore 649
        ...
        unsafe void AfterOnUpdate(JobHandle outputJob, bool throwException)
        {
            ...
            #if ENABLE_UNITY_COLLECTIONS_CHECKS
            SystemState.SetCurrentSystemIdForJobDebugger(state->m_PreviousSystemID);
            #endif
        }
