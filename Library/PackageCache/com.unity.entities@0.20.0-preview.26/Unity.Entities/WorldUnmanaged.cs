...
namespace Unity.Entities
{
    ...
    internal unsafe partial struct WorldUnmanagedImpl
    {
        ...
        internal AllocatorManager.Block UpdateAllocatorBlk;
        internal RewindableAllocator* UpdateAllocator0;
        internal RewindableAllocator* UpdateAllocator1;
        /// <summary>
        ...
        internal WorldUnmanagedImpl(ulong sequenceNumber, WorldFlags flags, AllocatorManager.AllocatorHandle allocatorHandle)
        {
            ...
            UpdateAllocatorBlk = m_AllocatorHandle.AllocateBlock(sizeof(RewindableAllocator), 16, 2);
            var updateAllocator = (RewindableAllocator*)UpdateAllocatorBlk.Range.Pointer;

            UpdateAllocator0 = &updateAllocator[0];
            *UpdateAllocator0 = default;
            UpdateAllocator0->Initialize(128 * 1024);

            UpdateAllocator1 = &updateAllocator[1];
            *UpdateAllocator1 = default;
            UpdateAllocator1->Initialize(128 * 1024);

            UpdateAllocator = UpdateAllocator0;
        }

        internal void Dispose()
        {
            UpdateAllocator1->Dispose();
            UpdateAllocator0->Dispose();
            m_AllocatorHandle.FreeBlock(ref UpdateAllocatorBlk);
    ...
    public unsafe struct WorldUnmanaged
    {
        ...
        WorldAllocator* m_WorldAllocatorPtr;
        ref WorldAllocator m_WorldAllocator => ref UnsafeUtility.AsRef<WorldAllocator>(m_WorldAllocatorPtr);
        ...
        {
            m_WorldAllocatorPtr = (WorldAllocator*)Memory.Unmanaged.Allocate(UnsafeUtility.SizeOf<WorldAllocator>(), 64, backingAllocatorHandle);
            m_WorldAllocator.Initialize(backingAllocatorHandle);
            m_BackingAllocatorHandle = backingAllocatorHandle;

            m_AllocatorHandle = m_WorldAllocator.Handle;
        ...
        internal void Dispose()
        {
            ...
            m_WorldAllocator.Dispose();
            Memory.Unmanaged.Free(m_WorldAllocatorPtr, m_BackingAllocatorHandle);
        }
