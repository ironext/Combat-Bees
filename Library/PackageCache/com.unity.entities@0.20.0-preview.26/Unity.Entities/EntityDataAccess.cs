...
namespace Unity.Entities
{
    ...
    unsafe struct EntityDataAccess : IDisposable
    {
        ...
        public void DestroyEntityDuringStructuralChange(NativeArray<Entity> entities)
        {
            ...
            EntitiesJournaling.RecordDestroyEntity(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length);
#endif
        ...
        public void DestroyEntityDuringStructuralChange(UnsafeCachedChunkList cache, UnsafeMatchingArchetypePtrList archetypeList , EntityQueryFilter filter)
        {
#if ENABLE_PROFILER
            using (var scope = StructuralChangesProfiler.BeginDestroyEntity(m_WorldUnmanaged))
#endif
            ...
            using (var chunks = ChunkIterationUtility.CreateArchetypeChunkArray(cache,archetypeList,Allocator.TempJob, ref filter, DependencyManager))
            {
                ...
                if (chunks.Length > 0)
                {
                    ...
                    {
#if DEVELOPMENT_BUILD || UNITY_EDITOR
                        EntitiesJournaling.RecordDestroyEntity(in m_WorldUnmanaged, (ArchetypeChunk*)chunks.GetUnsafeReadOnlyPtr(), chunks.Length);
#endif
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordDestroyEntity(in m_WorldUnmanaged, entities, count);
#endif
        ...
        internal EntityArchetype CreateArchetypeDuringStructuralChange(ComponentTypeInArchetype* typesInArchetype, int cachedComponentCount)
        {
            // Lookup existing archetype (cheap)
            EntityArchetype entityArchetype;
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordCreateEntity(in m_WorldUnmanaged, &entity, 1, null, 0);
#endif
        ...
        {
            Entity entity;
            CreateEntityDuringStructuralChange(archetype, &entity, 1);
            return entity;
        }
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordCreateEntity(in m_WorldUnmanaged, outEntities, count, (int*)archetype.Types, archetype.TypesCount);
#endif
        }
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, &entity, 1, &componentType.TypeIndex, 1);
#endif
        ...
        /// <exception cref="InvalidOperationException">Thrown if the component increases the shared component count of the entity's archetype to more than the maximum allowed.</exception>
        /// <exception cref="InvalidOperationException">Thrown if the component causes the size of the archetype to exceed the size of a chunk.</exception>
        public void AddComponentDuringStructuralChange(UnsafeCachedChunkList cache,UnsafeMatchingArchetypePtrList archetypeList ,EntityQueryFilter filter, ComponentType componentType)
        {
            if (archetypeList.Length == 0)
                return;
            ...
            using (var chunks = ChunkIterationUtility.CreateArchetypeChunkArray(cache,archetypeList, Allocator.TempJob, ref filter, DependencyManager))
            {
                ...
                {
#if DEVELOPMENT_BUILD || UNITY_EDITOR
                    EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, (ArchetypeChunk*)chunks.GetUnsafeReadOnlyPtr(), chunks.Length, &componentType.TypeIndex, 1);
#endif
        ...
        internal void AddComponentsDuringStructuralChange(UnsafeCachedChunkList cache,UnsafeMatchingArchetypePtrList archetypeList,EntityQueryFilter filter, ComponentTypes types)
        {
            ...
            using (var chunks = ChunkIterationUtility.CreateArchetypeChunkArray(cache,archetypeList, Allocator.TempJob, ref filter, DependencyManager))
            {
                ...
                {
#if DEVELOPMENT_BUILD || UNITY_EDITOR
                    EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, (ArchetypeChunk*)chunks.GetUnsafeReadOnlyPtr(), chunks.Length, types.Types, types.Length);
#endif
        ...
        public void AddComponentDuringStructuralChange(NativeArray<Entity> entities, ComponentType componentType)
        {
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length, &componentType.TypeIndex, 1);
#endif
...
#endif
            {
                if (entities.Length > FASTER_TO_BATCH_THRESHOLD &&
                    EntityComponentStore->CreateEntityBatchList(entities, componentType.IsSharedComponent ? 1 : 0, out var entityBatchList))
                {
                    StructuralChange.AddComponentEntitiesBatch(EntityComponentStore, (UnsafeList<EntityBatchInChunk>*)NativeListUnsafeUtility.GetInternalListDataPtrUnchecked(ref entityBatchList), componentType.TypeIndex);
        ...
        public void AddMultipleComponentsDuringStructuralChange(NativeArray<Entity> entities, ComponentTypes componentTypes)
        {
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length, componentTypes.Types, componentTypes.Length);
#endif
            ...
            {
                if (entities.Length > FASTER_TO_BATCH_THRESHOLD &&
                    EntityComponentStore->CreateEntityBatchList(entities, componentTypes.m_masks.SharedComponents, out var entityBatchList))
                {
                    StructuralChange.AddComponentsEntitiesBatch(EntityComponentStore, (UnsafeList<EntityBatchInChunk>*)NativeListUnsafeUtility.GetInternalListDataPtrUnchecked(ref entityBatchList), ref componentTypes);
                    entityBatchList.Dispose();
                }
                else
                {
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordRemoveComponent(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length, componentTypes.Types, componentTypes.Length);
#endif
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordRemoveComponent(in m_WorldUnmanaged, &entity, 1, &componentType.TypeIndex, 1);
#endif
        ...
        public void RemoveComponentDuringStructuralChange(UnsafeCachedChunkList cache, UnsafeMatchingArchetypePtrList archetypeList, EntityQueryFilter filter, ComponentType componentType)
        {
            if (archetypeList.Length == 0)
                return;
            EntityComponentStore->AssertCanRemoveComponent(componentType);
            ...
            using (var chunks = ChunkIterationUtility.CreateArchetypeChunkArray(cache,archetypeList,Allocator.TempJob, ref filter, DependencyManager))
            {
                ...
                {
#if DEVELOPMENT_BUILD || UNITY_EDITOR
                    EntitiesJournaling.RecordRemoveComponent(in m_WorldUnmanaged, (ArchetypeChunk*)chunks.GetUnsafeReadOnlyPtr(), chunks.Length, &componentType.TypeIndex, 1);
#endif
        ...
        /// <param name="filter"></param>
        /// <param name="componentTypes"></param>
        internal void RemoveMultipleComponentsDuringStructuralChange(UnsafeCachedChunkList cache,UnsafeMatchingArchetypePtrList archetypeList,EntityQueryFilter filter, ComponentTypes componentTypes)
        {
            ...
            using (var chunks = ChunkIterationUtility.CreateArchetypeChunkArray( cache,archetypeList,Allocator.TempJob, ref filter, DependencyManager))
            {
                ...
                {
#if DEVELOPMENT_BUILD || UNITY_EDITOR
                    EntitiesJournaling.RecordRemoveComponent(in m_WorldUnmanaged, (ArchetypeChunk*)chunks.GetUnsafeReadOnlyPtr(), chunks.Length, componentTypes.Types, componentTypes.Length);
#endif
        ...
        public void RemoveComponentDuringStructuralChange(NativeArray<Entity> entities, ComponentType componentType)
        {
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordRemoveComponent(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length, &componentType.TypeIndex, 1);
#endif
...
#endif
            {
                if (entities.Length > FASTER_TO_BATCH_THRESHOLD &&
                    EntityComponentStore->CreateEntityBatchList(entities, 0, out var entityBatchList))
                {
                    StructuralChange.RemoveComponentEntitiesBatch(EntityComponentStore, (UnsafeList<EntityBatchInChunk>*)NativeListUnsafeUtility.GetInternalListDataPtrUnchecked(ref entityBatchList), componentType.TypeIndex);
                    entityBatchList.Dispose();
                }
                else
                {
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetComponentData(in m_WorldUnmanaged, &entity, 1, &typeIndex, 1, UnsafeUtility.AddressOf(ref componentData), UnsafeUtility.SizeOf<T>());
#endif
        }
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetComponentData(in m_WorldUnmanaged, &entity, 1, &typeIndex, 1, data, size);
#endif
        }
        ...
        internal void AddSharedComponentDataDuringStructuralChange(NativeArray<ArchetypeChunk> chunks, int sharedComponentIndex, ComponentType componentType)
        {
            ...
            EntitiesJournaling.RecordAddComponent(in m_WorldUnmanaged, chunksPtr, chunks.Length, &componentType.TypeIndex, 1);
            EntitiesJournaling.RecordSetSharedComponentData(in m_WorldUnmanaged, chunksPtr, chunks.Length, &componentType.TypeIndex, 1);
#endif
        ...
        [NotBurstCompatible]
        public void AddSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(NativeArray<Entity> entities, int typeIndex, int hashCode, object componentData)
        {
            if (entities.Length == 0)
                return;
            ...
            SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(entities, typeIndex, hashCode, componentData);
        }
        ...
        /// <param name="componentData"></param>
        [NotBurstCompatible]
        public bool AddSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(Entity entity, int typeIndex, int hashCode, object componentData)
        {
            ...
            SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(entity, typeIndex, hashCode, componentData);
        ...
        /// <param name="componentData"></param>
        [NotBurstCompatible]
        public void AddSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache,EntityQueryFilter filter, int typeIndex, int hashCode, object componentData)
        {
            if (archetypeList.Length == 0)
                return;
        ...
        {
            var jobHandle = Entities.EntityComponentStore.GetCreatedAndDestroyedEntities(EntityComponentStore, state, createdEntities, destroyedEntities, true);
        ...
        {
            Entities.EntityComponentStore.GetCreatedAndDestroyedEntities(EntityComponentStore, state, createdEntities, destroyedEntities, false);
        }
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetSharedComponentData(in m_WorldUnmanaged, &entity, 1, &typeIndex, 1);
#endif
        }
        ...
        /// <param name="componentData"></param>
        [NotBurstCompatible]
        public void SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(Entity entity, int typeIndex, int hashCode, object componentData)
        {
            EntityComponentStore->AssertEntityHasComponent(entity, typeIndex);
        ...
        [NotBurstCompatible]
        public void SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(NativeArray<Entity> entities, int typeIndex, int hashCode, object componentData)
        {
            if (entities.Length == 0)
                return;
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetSharedComponentData(in m_WorldUnmanaged, (Entity*)entities.GetUnsafeReadOnlyPtr(), entities.Length, &typeIndex, 1);
#endif
        }

#if ENABLE_UNITY_COLLECTIONS_CHECKS
        [BurstCompatible(GenericTypeArguments = new[] { typeof(BurstCompatibleBufferElement) }, CompileTarget = BurstCompatibleAttribute.BurstCompatibleCompileTarget.Editor)]
        public DynamicBuffer<T> GetBuffer<T>(Entity entity, AtomicSafetyHandle safety, AtomicSafetyHandle arrayInvalidationSafety) where T : struct, IBufferElementData
#else
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetBuffer(in m_WorldUnmanaged, &entity, 1, &componentTypeIndex, 1);
#endif
        }
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordCreateEntity(in m_WorldUnmanaged, outputEntities, count, null, 0); //TODO: component types
#endif
        }

        internal void InstantiateInternalDuringStructuralChange(Entity* srcEntities, Entity* outputEntities, int count, int outputCount, bool removePrefab)
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
            if (count < 0)
                throw new ArgumentOutOfRangeException("count must be non-negative");
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordCreateEntity(in m_WorldUnmanaged, outputEntities, outputCount, null, 0); //TODO: component types
#endif
        }
        ...
        public void SwapComponents(ArchetypeChunk leftChunk, int leftIndex, ArchetypeChunk rightChunk, int rightIndex)
        {
            ...
            if (leftIndex < 0 || leftIndex >= leftChunk.Count)
                throw new ArgumentOutOfRangeException($"leftIndex {leftIndex} is out of range for chunk count {leftChunk.Count}");
            if (rightIndex < 0 || rightIndex >= rightChunk.Count)
                throw new ArgumentOutOfRangeException($"rightIndex {rightIndex} is out of range for chunk count {rightChunk.Count}");
#endif
            if (!IsInExclusiveTransaction)
                BeforeStructuralChange();
        ...
        [Obsolete("Please use RemoveComponentDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        ...
        [Obsolete("Please use RemoveComponentDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        public void RemoveComponent(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache, EntityQueryFilter filter, ComponentType componentType)
        {
            AssertMainThread();
            var chunks = ChunkIterationUtility.CreateArchetypeChunkArray(cache,archetypeList, Allocator.TempJob, ref filter, DependencyManager);
            RemoveComponent(chunks, componentType);
            chunks.Dispose();
        }

        [Obsolete("Please use AddComponentDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        public void AddComponent(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache, EntityQueryFilter filter,
        ...
        [Obsolete("Please use DestroyEntityInternalDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        public void DestroyEntity(Entity entity)
        {
            DestroyEntityInternalDuringStructuralChange(&entity, 1);
        }

        [Obsolete("Please use DestroyEntityDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        public void DestroyEntity(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache,EntityQueryFilter filter)
        {
            AssertMainThread();
        ...
        [Obsolete("Please use AddComponentsDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        internal void AddComponents(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache,EntityQueryFilter filter, ComponentTypes types)
        {
            AssertMainThread();
            EntityComponentStore->AssertCanAddComponents(archetypeList, types);
        ...
        [Obsolete("Please use CreateEntityDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        ...
        [Obsolete("Please use AddSharedComponentDataDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        [NotBurstCompatible]
        ...
        [Obsolete("Please use AddSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        [NotBurstCompatible]
        public void AddSharedComponentDataBoxedDefaultMustBeNull(UnsafeMatchingArchetypePtrList archetypeList, UnsafeCachedChunkList cache, EntityQueryFilter filter, int typeIndex, int hashCode, object componentData, ManagedComponentStore managedComponentStore)
        {
            AssertMainThread();
        ...
        [Obsolete("Please use InstantiateInternalDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        ...
        {
            //TODO: optimization: set value when component is added, not afterwards
            AddComponentDuringStructuralChange(entity, ComponentType.FromTypeIndex(typeIndex));
            SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange(entity, typeIndex, hashCode, componentData);
        }
        ...
        [Obsolete("Please use SetSharedComponentDataBoxedDefaultMustBeNullDuringStructuralChange. (RemovedAfter 2021-07-10)")]
        [NotBurstCompatible]
    ...
    static unsafe partial class EntityDataAccessManagedComponentExtensions
    {
        ...
        public static void SetComponentObject(ref this EntityDataAccess dataAccess, Entity entity, ComponentType componentType, object componentObject)
        {
#if ENABLE_UNITY_COLLECTIONS_CHECKS || UNITY_DOTS_DEBUG
            if (!componentType.IsManagedComponent)
...
#if DEVELOPMENT_BUILD || UNITY_EDITOR
            EntitiesJournaling.RecordSetComponentObject(in dataAccess.m_WorldUnmanaged, &entity, 1, &componentType.TypeIndex, 1);
#endif
        }
    }
}
