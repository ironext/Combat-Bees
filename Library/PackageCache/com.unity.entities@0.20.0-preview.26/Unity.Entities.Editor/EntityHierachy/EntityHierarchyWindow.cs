...
namespace Unity.Entities.Editor
{
    class EntityHierarchyWindow : DOTSEditorWindow, IEntityHierarchy, IHasCustomMenu
    {
        ...
        {
            m_EnableLiveLinkMessage.SetVisibility(!EditorApplication.isPlaying && !LiveLinkConfigHelper.LiveLinkEnabledInEditMode);
            m_EntityHierarchy.SetVisibility(EditorApplication.isPlaying || LiveLinkConfigHelper.LiveLinkEnabledInEditMode);
            m_Header.SetVisibility(EditorApplication.isPlaying || LiveLinkConfigHelper.LiveLinkEnabledInEditMode);
        }
