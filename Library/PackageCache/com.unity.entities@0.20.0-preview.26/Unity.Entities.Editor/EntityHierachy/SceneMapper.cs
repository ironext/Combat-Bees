...
namespace Unity.Entities.Editor
{
    interface ISceneMapper
    {
        ...
        (int subSceneId, bool isDynamicSubScene) GetSubSceneId(Hash128 subSceneHash);
    ...
    class SceneMapper : ISceneMapper, IDisposable
    {
        ...
        {
            return TryGetSceneOrSubSceneInstanceId(subSceneHash, out var instanceId)
                ? (instanceId, false)
                : (subSceneHash.GetHashCode(), true);
        }
