...
namespace Unity.Entities.Editor
{
    partial class StructuralChangesProfilerModule : StructuralChangesProfilerModuleBase
    {
        ...
        public override VisualElement CreateView(Rect area)
        {
            ...
            m_SearchElement.AddSearchFilterCallbackWithPopupItem<StructuralChangesProfilerTreeViewItemData, double>("cost", data => data.ElapsedNanoseconds * 1e-6, "Cost (ms)");
        ...
        {
            if (nanoseconds >= 1e3)
                return (nanoseconds * 1e-6).ToString("F3", CultureInfo.InvariantCulture) + " ms";
