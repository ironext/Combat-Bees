...
namespace Unity.Entities.Editor
{
    partial class HierarchyWindow : DOTSEditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            m_EnableLiveLinkMessage = CreateEnableLiveLinkMessage(rootVisualElement);
            
            Selection.selectionChanged += OnGlobalSelectionChanged;
            LiveLinkConfigHelper.LiveLinkEnabledChanged += OnLiveLinkEnabledChanged;
        ...
        void OnBecameVisible()
        {
            ...
            m_GlobalSelectionRequestUpdateVersion = m_Hierarchy.UpdateVersion;
        }
        ...
        VisualElement CreateEnableLiveLinkMessage(VisualElement root)
        {
            var element = new VisualElement { style = { flexGrow = 1 } };
            Resources.Templates.EntityHierarchyEnableLiveLinkMessage.Clone(element);
            element.Q<Button>().clicked += () => LiveLinkConfigHelper.LiveLinkEnabledInEditMode = true;
            root.Add(element);
            return element;
        }
        ...
        void UpdateVisibility()
        {
            ...
            m_EnableLiveLinkMessage.SetVisibility(m_ContainsAnyWorld && (!EditorApplication.isPlaying && !LiveLinkConfigHelper.LiveLinkEnabledInEditMode));
            m_HierarchyElement.SetVisibility(m_ContainsAnyWorld && (EditorApplication.isPlaying || LiveLinkConfigHelper.LiveLinkEnabledInEditMode));
            m_Toolbar.SetVisibility(m_ContainsAnyWorld && (EditorApplication.isPlaying || LiveLinkConfigHelper.LiveLinkEnabledInEditMode));
        }
