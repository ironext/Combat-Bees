...
namespace Unity.Entities.Editor
{
    ...
    unsafe partial struct HierarchyNodeStore : IDisposable
    {
        ...
        /// <summary>
        /// Cache map used when integrating entity changes.
        /// </summary>
        NativeHashMap<Entity, Scene> m_EntityScenes;
        ...
        public HierarchyNodeStore(Allocator allocator)
        {
            ...
            m_EntityScenes = new NativeHashMap<Entity, Scene>(16, allocator);
