                ...
                switch (state)
                {
                    case UpdateStep.IntegrateEntityChanges:
                    {
                        if (m_HierarchyEntityChanges.HasChanges())
                        {
                            ...
                            m_IntegrateEntityChangesEnumerator = m_HierarchyNodeStore.CreateIntegrateEntityChangesEnumerator(m_World.EntityManager, m_HierarchyEntityChanges, EntityChangeIntegrationBatchSize);
                        }
                        else
                        {
                    ...
                    case UpdateStep.ExportImmutable:
                    {
                        ...
                        {
                            m_ExportImmutableEnumerator = m_HierarchyNodeStore.CreateBuildImmutableEnumerator(m_World.EntityManager, m_ExportImmutableState,m_HierarchyNodeImmutableStore.GetWriteBuffer(), m_HierarchyNodeImmutableStore.GetReadBuffer(),
