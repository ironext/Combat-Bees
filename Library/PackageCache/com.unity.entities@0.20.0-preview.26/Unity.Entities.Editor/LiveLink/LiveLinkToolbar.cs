...
namespace Unity.Entities.Editor
{
    class LiveLinkToolbar
    {
        ...
        {
            EditorApplication.update += AddLiveLinkDropdown;
            void AddLiveLinkDropdown()
            {
                ...
                var container = new IMGUIContainer
                {
                    name = "LiveLink",
                    style = { width = 40 },
                    onGUIHandler = () => s_LinkConnectionsDropdown.DrawDropdown()
                };
                container.AddToClassList("unity-editor-toolbar-element");
                root.Add(container);
        ...
        static void DrawPlaybar(CommandExecuteContext ctx)
        {
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                ActiveBuildConfigurationDropdown.Instance.Draw();
#endif
