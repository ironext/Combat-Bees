...
namespace Unity.Entities.Editor
{
    ...
    {
        const string k_LiveLinkEditorMenu = "DOTS/Conversion Settings/";

        const string kLiveConversionEnabled = k_LiveLinkEditorMenu  + "Live Conversion Enabled";
        const string kAuthoringState = k_LiveLinkEditorMenu   + "Live Conversion: Authoring State in Scene View";
        const string kRuntimeState = k_LiveLinkEditorMenu + "Live Conversion: Runtime State in Scene View";
        ...
        const string k_ConversionIncrementalConversionWithLogging = k_LiveLinkEditorMenu + "Incremental Conversion Logging";
        ...
        const string k_ConversionIncrementalConversionWithDebug = k_LiveLinkEditorMenu + "Incremental Conversion Debug";
