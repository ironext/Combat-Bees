...
namespace Unity.Entities.Editor
{
    ...
    {
        static readonly Lazy<GUIContent> s_LiveLinkIcon = new Lazy<GUIContent>(() => new GUIContent(PackageResources.LoadIcon("LiveLink/LiveLink.png")));
        static readonly Lazy<GUIContent> s_LiveLinkActiveIcon = new Lazy<GUIContent>(() => new GUIContent(PackageResources.LoadIcon("LiveLink/LiveLinkActive.png")));
        ...
        public void DrawDropdown()
        {
            ...
            var icon = hasConnectedDevices ? s_LiveLinkActiveIcon.Value : s_LiveLinkIcon.Value;
            icon.tooltip = hasConnectedDevices
                ? "View linked devices."
                : "No devices currently linked. Create a Live Link build to connect a device.";

            var dropdownRect = GUILayoutUtility.GetRect(icon, LiveLinkStyles.Dropdown);
            if (GUI.Button(dropdownRect, icon, LiveLinkStyles.Dropdown))
            {
        ...
        internal class LiveLinkConnectionsView : IDisposable
        {
            ...
            static readonly VisualElementTemplate s_DropdownTemplate = PackageResources.LoadTemplate("LiveLink/live-link-dropdown");
            static readonly VisualElementTemplate s_DropdownGroupTemplate = PackageResources.LoadTemplate("LiveLink/live-link-dropdown-group");
            static readonly VisualElementTemplate s_DropdownGroupItemTemplate = PackageResources.LoadTemplate("LiveLink/live-link-dropdown-group-item");
            ...
            public void BuildFullUI(VisualElement root)
            {
                ...
                var container = s_DropdownTemplate.Clone();
            ...
            void BuildConnectionListUI()
            {
                ...
                {
                    var groupVisualElement = s_DropdownGroupTemplate.Clone();
                    ...
                    {
                        connectionCount++;
                        var connectionVisualElement = s_DropdownGroupItemTemplate.Clone();
