...
using static Unity.Scenes.Editor.Tests.TestWithEditorLiveLink;
...
namespace Unity.Scenes.Editor.Tests
{
    ...
    {
        [SerializeField] private TestWithEditorLiveLink m_LiveLinkTest;
        ...
        {
            if (!m_LiveLinkTest.OneTimeSetUp())
                return;
        ...
        {
            m_LiveLinkTest.OneTimeTearDown();
        }

        [SetUp]
        public void SetUp()
        {
            m_LiveLinkTest.SetUp();
        }
        ...
        Scene CreateTmpScene() => m_LiveLinkTest.CreateTmpScene();

        SubScene CreateSubSceneFromObjects(string name, bool keepOpen, Func<List<GameObject>> createObjects) =>
            m_LiveLinkTest.CreateSubSceneFromObjects(name, keepOpen, createObjects);

        SubScene CreateEmptySubScene(string name, bool keepOpen) => m_LiveLinkTest.CreateEmptySubScene(name, keepOpen);

        World GetLiveLinkWorld(Mode playmode, bool removeWorldFromPlayerLoop = true) =>
            m_LiveLinkTest.GetLiveLinkWorld(playmode, removeWorldFromPlayerLoop);

        IEditModeTestYieldInstruction GetEnterPlayMode(Mode playmode) => m_LiveLinkTest.GetEnterPlayMode(playmode);

        IEnumerator UpdateEditorAndWorld(World w) => m_LiveLinkTest.UpdateEditorAndWorld(w);
        ...
        [UnityTest]
        public IEnumerator LiveLink_ReEnableEntityHierarchy_WhenParentGameObjectIsReEnabledFromSavedSubScene()
        {
        ...
        {
            {
                ...
                m_PrefabPath = m_LiveLinkTest.Assets.GetNextPath("Test.prefab");
